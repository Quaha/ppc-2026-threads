...
#pragma omp parallel for default(none) shared(points, reference, num_points) reduction(&& : all_identical)
...
#pragma omp parallel default(none) shared(points, num_points, lowest)
  {
